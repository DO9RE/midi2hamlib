...
```
sudo apt install libhamlib libhamlib-utils
```
...
the end, it prints a summary of enabled and disabled options. Revise this
section in order to detect major issues. We do not expect anything severe
going wrong.
